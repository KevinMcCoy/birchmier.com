...
15. Yelp
16. Youtube
17. any further content you wish by using the filter hook `speed-contact-bar-icons`. See [Other Notes](https://wordpress.org/plugins/speed-contact-bar/other_notes/)
