...
<div class="wrap" id="ls-list-page">
	...
	<div id="ls-import-samples-template" class="ls-pointer ls-box">
		...
		<ul class="inner">
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=Shop-homepage.zip', 'import-sample-sliders') ?>">
					<div class="title">Shop Homepage</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=v2-homepage.zip', 'import-sample-sliders') ?>">
					<div class="title">Homepage V2</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=About-3.zip', 'import-sample-sliders') ?>">
					<div class="title">About 3</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=Careers.zip', 'import-sample-sliders') ?>">
					<div class="title">Careers</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=one-page-portfolio.zip', 'import-sample-sliders') ?>">
					<div class="title">One Page Portfolio</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=pricing-slider.zip', 'import-sample-sliders') ?>">
					<div class="title">Pricing Slider</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=Product-launch.zip', 'import-sample-sliders') ?>">
					<div class="title">Product Launch</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=Service-1.zip', 'import-sample-sliders') ?>">
					<div class="title">Service 1</div>
				</a>
			</li>
			<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=services-2.zip', 'import-sample-sliders') ?>">
					<div class="title">Services 2</div>
				</a>
			</li>
