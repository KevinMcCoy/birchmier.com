		 ...
		 <?php 
		 	...
		 	if($post_type == 'video'){
		 		if($video_type_website == 'youtube'){
		 			$post_type_link = 'http://www.youtube.com/watch?v='.$video_type_video_id;
		 		}else if($video_type_website == 'vimeo'){
		 			$post_type_link = 'https://vimeo.com/'.$video_type_video_id;
		 		}else{
		 			$post_type_link = 'http://www.dailymotion.com/video/'.$video_type_video_id;
		 		}
		 	}else{
		 		$post_type_link = $image_src_array[0];
		 	}
		 ?>
